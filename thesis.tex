...
% タイトル
\def\title{宇宙のDTNにおけるContact Plan臨時更新対象の天体内への限定}
% 英語タイトル
\def\etitle{Restriction of Contact Plan in the DTN of the Universe to within celestial bodies subject to temporary updating}
% 著者(日本語)
\def\author{鈴木　翔太}
% 著者(英語)
