...
% タイトル
\def\title{ContactPlanの臨時更新の天体内への限定的な伝播の提案（仮）}
% 英語タイトル
\def\etitle{Proposal for limited propagation of ContactPlan temporary updates within the planet (tentative)}
% 著者(日本語)
\def\author{鈴木　翔太}
% 著者(英語)
...
\input{src/04_design_and_impl.ja}
