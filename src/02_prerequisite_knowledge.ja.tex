...
本章では、そのようなDTNでのルーティングにおいて中心的な構想であるContact Graph Routing（CGR）について説明する。
...
\begin{figure}[tbh]
    \centering
    \includegraphics[width=0.7\textheight]{img/contact_example_topology.pdf}
    \caption{}
...
\begin{figure}[tbh]
    \centering
    \includegraphics[width=0.7\textheight]{img/contact_example_contactplan.pdf}
    \caption{}
